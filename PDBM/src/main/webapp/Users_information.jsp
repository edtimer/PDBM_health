		...
		<div class="row">
			<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
				...
				<ul class="nav nav-pills flex-column mb-auto">
					...
					<li><a href="AdminController" class="nav-link text-white"> Dashboard </a></li>
					<li><a href="AdminController" class="nav-link text-white active">
					...
					<div class="card tabs">
						<ul class="list-group list-group-flush">
							<li class="list-group-item "><b>First Name :</b> <c:out
									value="${Users.firstName}" /></li>
							<li class="list-group-item "><b>Last Name :</b> <c:out
									value="${Users.lastName}" /></li>

							<li class="list-group-item"><b>PhoneNumber :</b> <c:out
									value="${Users.phoneNumber}" /></li>

							<li class="list-group-item"><b>Email :</b>
							<c:out value="${Users.Email}" /></li>
