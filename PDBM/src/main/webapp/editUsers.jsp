...
<!doctype html>
<c:set var="staff" value="${Users}" scope="session" />
<html lang="en">
<head>
<meta charset="utf-8">
...
<body>
	...
	<div></div>
	<form action=<c:url value="/updateStaff?id=${Users.user_id}"/>
		method="post">
		<div class="container-fluid">
			<div class="row">
						...
						<div class="card tabs">
							<ul class="list-group list-group-flush ">
								...
								<li class="list-group-item "><b>staff ID :</b> <c:out
										value="${Users.user_id}" /></li>

								<li class="list-group-item "><b>First Name :</b> <input
									name="firstName" type="text"
									value="<c:out value='${Users.firstName}'/>"></li>

								<li class="list-group-item "><b>Last Name :</b> <input
									name="lastName" type="text"
									value="<c:out value='${Users.lastName}'/>"></li>

								<li class="list-group-item"><b>phone :</b> <input
									name="phoneNumber" type="text"
									value="<c:out value='${Users.phoneNumber}'/>"></li>

								<li class="list-group-item"><b>email :</b> <input
									name="email" type="text"
									value="<c:out value='${Users.email}'/>"></li>

								<li class="list-group-item"><b>password # :</b> <input
									name="password" type="text"
									value="<c:out value='${Users.password}'/>"></li>

								<li class="list-group-item"><b>Access:</b> <input
									name="access" type="text"
									value="<c:out value='${Users.access}'/>"></li>
